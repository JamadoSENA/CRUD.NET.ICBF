    ...
    public partial class IcbfContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Acudiente>(entity =>
            {
                ...
                entity.Property(e => e.Cedula).ValueGeneratedNever().HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Ninio>(entity =>
            {
                ...
                entity.Property(e => e.RegistroNiup).ValueGeneratedNever().HasColumnType("int(11)").HasColumnName("RegistroNIUP");
                entity.Property(e => e.CiudadNacimiento).HasMaxLength(100);
                entity.Property(e => e.Direccion).HasMaxLength(255);
                entity.Property(e => e.Eps).HasMaxLength(50).HasColumnName("EPS");
